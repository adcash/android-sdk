...
public class FeedRecyclerViewAdapter extends RecyclerViewWithAdsAdapter<DummyContent.DummyItem> {


    public FeedRecyclerViewAdapter(Activity activity, List<DummyContent.DummyItem> itemList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case VIEW_TYPE_AD:
                View adItemView = inflater.inflate(R.layout.fragment_feed_ad_item, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        switch (getItemViewType(position)) {
            ...
            default:
                ...
                dummyHolder.mIconView.setImageResource(item.imageId);
